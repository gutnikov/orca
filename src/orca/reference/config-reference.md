...
|---|---|---|
| `failure_context` | Worker fails or returns `failed` outcome | Error message from last failure |
| `base_branch` | Worker dispatched | Git branch for merging (injected into issue context) |
