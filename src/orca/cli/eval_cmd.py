      ...
      prompt:
        text: |
          ...
          4. When the user submits, you will receive a JSON envelope on stdin.
             ...
             - `actions`: a dict mirroring the submitted checkbox values
               (`update_prompts`, `update_assertions`, `update_input`,
               `commit_after`), preserving booleans.
